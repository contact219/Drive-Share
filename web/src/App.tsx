...
import HostBookings from "./views/HostBookings";
...
import AdminVerifications from "./views/admin/Verifications";
...
import AdminServiceAreas from "./views/admin/ServiceAreas";
